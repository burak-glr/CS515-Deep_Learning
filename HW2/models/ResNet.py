"""ResNet implementation for CIFAR-10, used as the teacher in knowledge distillation.
...
class ResNet(nn.Module):
    ...
    def _make_layer(self, block, channels: int, num_blocks: int, norm, stride: int) -> nn.Sequential:
